 ...
 * @brief Runnable tour of the hand-rolled doubly-linked List.
 *
 * Demonstrates:
 *   - push_front / push_back, pop_front / pop_back, front / back
 *   - Initializer list, bidirectional iteration, copy and move
 *   - LRU-style usage, playlists, list vs vector trade-offs, clear
 */
...
=== Example 2: Initializer List ===
Initialized list: 10 20 30 40 50 
...
Copied list size: 3
Moved list size: 3
Original after move: 0

=== Example 5: LRU Cache Simulation ===
  Access page 1: Cache: 1 
  Access page 2: Cache: 2 1 
  Access page 3: Cache: 3 2 1 
  Access page 1: (hit) Cache: 1 3 2 
  Access page 4: Cache: 4 1 3 
...
=== Example 7: When to Use List vs Vector ===
List advantages:
  - O(1) insert/erase at any position (with iterator)
  - No reallocation needed
  - Stable iterators/pointers
