...
bool test_copy_assignment() {
    ...
    // Self-assignment (via alias so -Wself-assign isn't tripped)
    Optional<int>& alias = opt1;
    opt1 = alias;
 ...
 * ----------------------------------------------------------------------------
╔════════════════════════════════════════════════╗
║        Optional Container Test Suite           ║
╚════════════════════════════════════════════════╝

Running test_default_construction... ✅ PASSED
Running test_value_construction... ✅ PASSED
Running test_value_or... ✅ PASSED
Running test_exception_on_empty... ✅ PASSED
Running test_reset... ✅ PASSED
Running test_copy_construction... ✅ PASSED
Running test_move_construction... ✅ PASSED
Running test_copy_assignment... ✅ PASSED
Running test_arrow_operator... ✅ PASSED
Running test_reassignment... ✅ PASSED
Running test_string_type... ✅ PASSED
Running test_resource_management... ✅ PASSED
Running test_bool_conversion... ✅ PASSED
