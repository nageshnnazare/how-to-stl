...
TEST(self_move_assignment) {
    ...
    auto& alias = ptr;
    ptr = std::move(alias);  // Self-move (via alias so -Wself-move isn't tripped)
...
Running test: array_construction... PASSED
Running test: make_unique_array... PASSED
Running test: array_subscript... PASSED
Running test: custom_deleter... PASSED
...
Running test: function_modify... PASSED
Running test: function_return... PASSED
Running test: multiple_reset... PASSED
Running test: reset_with_get... PASSED
Running test: move_from_empty... PASSED
