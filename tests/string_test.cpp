...
TEST(move_assignment) {
    ...
    s2 = std::move(s1);
    ASSERT_STREQ(s2.c_str(), "This is a longer string to avoid SSO");
    // For heap strings the buffer is stolen (pointer moved), not copied.
    ASSERT_EQ(s2.c_str(), s1_data);
}
...
TEST(self_assignment) {
    String s("Test");
    String& alias = s;
    s = alias;  // Self-assignment (via alias so -Wself-assign isn't tripped)
...
Running test: cstring_construction... PASSED
Running test: repeated_char_construction... PASSED
Running test: substring_construction... PASSED
Running test: copy_construction... PASSED
Running test: move_construction_sso... PASSED
Running test: move_construction_heap... PASSED
Running test: copy_assignment... PASSED
Running test: move_assignment... PASSED
Running test: cstring_assignment... PASSED
Running test: char_assignment... PASSED
Running test: self_assignment... PASSED
Running test: subscript_operator... PASSED
Running test: at_method... PASSED
Running test: at_out_of_range... PASSED
Running test: front_back... PASSED
Running test: c_str_data... PASSED
Running test: iterators_begin_end... PASSED
Running test: const_iterators... PASSED
Running test: range_based_for... PASSED
Running test: modify_via_iterator... PASSED
Running test: size_length... PASSED
Running test: empty_check... PASSED
Running test: capacity_sso... PASSED
Running test: capacity_heap... PASSED
Running test: reserve... PASSED
Running test: shrink_to_fit_heap... PASSED
Running test: clear... PASSED
Running test: append_string... PASSED
Running test: append_cstring... PASSED
Running test: append_repeated_char... PASSED
Running test: operator_plus_equals_string... PASSED
Running test: operator_plus_equals_cstring... PASSED
Running test: operator_plus_equals_char... PASSED
Running test: push_back... PASSED
Running test: pop_back... PASSED
Running test: insert_at_position... PASSED
Running test: erase_substring... PASSED
Running test: erase_all... PASSED
Running test: replace_substring... PASSED
Running test: replace_longer... PASSED
Running test: resize_grow... PASSED
Running test: resize_shrink... PASSED
Running test: swap_strings... PASSED
Running test: find_substring... PASSED
Running test: find_char... PASSED
Running test: find_from_position... PASSED
Running test: rfind_char... PASSED
Running test: substr... PASSED
Running test: substr_to_end... PASSED
Running test: compare_strings... PASSED
Running test: compare_cstring... PASSED
Running test: concat_string_string... PASSED
Running test: concat_string_cstring... PASSED
Running test: concat_cstring_string... PASSED
Running test: concat_string_char... PASSED
Running test: concat_char_string... PASSED
Running test: equality_operators... PASSED
Running test: equality_with_cstring... PASSED
Running test: relational_operators... PASSED
Running test: output_stream... PASSED
Running test: input_stream... PASSED
Running test: input_stream_whitespace... PASSED
Running test: sso_short_string... PASSED
Running test: sso_boundary... PASSED
Running test: heap_allocation... PASSED
Running test: sso_to_heap_transition... PASSED
Running test: empty_string_operations... PASSED
Running test: multiple_appends... PASSED
Running test: large_string... PASSED
Running test: null_cstring... PASSED
Running test: vector_of_strings... PASSED
Running test: vector_resize... PASSED
Running test: multiple_small_operations... PASSED
Running test: copy_performance... PASSED

========================================
  String Class Test Suite              
========================================
