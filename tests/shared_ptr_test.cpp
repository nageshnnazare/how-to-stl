...
Running test: make_shared... PASSED
Running test: copy_construction... PASSED
Running test: move_construction... PASSED
Running test: copy_assignment... PASSED
Running test: multiple_copies... PASSED
Running test: copy_in_container... PASSED
Running test: move_assignment... PASSED
Running test: nullptr_assignment... PASSED
Running test: use_count_tracking... PASSED
Running test: unique_check... PASSED
Running test: reset_empty... PASSED
Running test: reset_with_pointer... PASSED
Running test: reset_shared_copy... PASSED
Running test: weak_ptr_creation... PASSED
Running test: weak_ptr_from_shared... PASSED
Running test: weak_ptr_lock... PASSED
Running test: weak_ptr_expiration... PASSED
Running test: weak_ptr_copy... PASSED
Running test: weak_ptr_reset... PASSED
Running test: get... PASSED
Running test: dereference_operator... PASSED
Running test: arrow_operator... PASSED
Running test: bool_conversion... PASSED
Running test: polymorphic_deletion... PASSED
Running test: derived_to_base_conversion... PASSED
Running test: dynamic_cast_success... PASSED
Running test: dynamic_cast_failure... PASSED
Running test: nullptr_comparison... PASSED
Running test: pointer_comparison... PASSED
Running test: function_by_value... PASSED
Running test: function_by_reference... PASSED
Running test: function_return... PASSED
Running test: swap_method... PASSED
Running test: multiple_reset... PASSED
Running test: shared_then_weak... PASSED
Running test: lock_multiple_times... PASSED
Running test: circular_reference_with_weak... SKIPPED
 PASSED

========================================
  shared_ptr Test Suite                
========================================
