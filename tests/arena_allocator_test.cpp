 ...
 * ----------------------------------------------------------------------------
╔════════════════════════════════════════════════╗
║     Thread Arena Allocator Test Suite         ║
╚════════════════════════════════════════════════╝

✓ Basic allocation returns non-null
✓ Second allocation returns non-null
✓ Allocations are different
✓ Arena used bytes > 0
✓ Arena capacity correct
✓ 16-byte aligned allocation
✓ 32-byte aligned allocation
✓ 64-byte aligned allocation
✓ First large allocation succeeds
✓ Second large allocation succeeds
✓ Allocation beyond capacity fails
✓ Arena has used memory
✓ Arena reset clears memory
✓ Arena capacity unchanged after reset
✓ Can allocate after reset
✓ All threads allocated successfully
✓ Correct number of arenas created
✓ Total capacity correct
✓ Scoped arena allocates
✓ Scoped arena resets on destruction
✓ Scoped create returns non-null
✓ Scoped create initializes value
✓ Scoped create with constructor
✓ Arena vector starts empty
✓ Arena vector initial size is 0
✓ Arena vector size after pushes
✓ Arena vector not empty
✓ Arena vector first element
✓ Arena vector last element
✓ Arena vector capacity grew
✓ Arena vector iteration
✓ Global stats num_arenas
✓ Global stats total_capacity
✓ Global stats total_used
✓ Global stats total_available
✓ Arenas have used memory
✓ Reset all clears all arenas
✓ Arenas still exist after reset all
✓ Typed allocator allocation
✓ Typed allocator construct
✓ Initial capacity
✓ Capacity grew after exceeding initial
✓ All elements preserved
✓ Concurrent access all succeeded
✓ Correct number of arenas after concurrent access
